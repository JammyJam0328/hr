                        ...
                        <div class="mt-2">
                            <form action=""
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <input wire:model.defer="create_user_name"
                                            type="text"
                                            name="username"
                                            id="username"
                                            class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                    <x-shared.error-message name="create_user_name" />
                                </div>
                                <div>
                                    <label for="email"
                                        class="block text-sm font-medium text-gray-700">Email</label>
                                    <div class="mt-1">
                                        <input wire:model.defer="create_email"
                                            type="email"
                                            name="email"
                                            id="email"
                                            class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                    <x-shared.error-message name="create_email" />
                                </div>
                                <div>
                                    <label for="password"
                                        class="block text-sm font-medium text-gray-700">Password</label>
                                    <div class="mt-1">
                                        <input wire:model.defer="create_password"
                                            type="password"
                                            name="password"
                                            id="password"
                                            class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                    <x-shared.error-message name="create_password" />
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <select wire:model.defer="create_role"
                                            name="role"
                                            id="role"
                                    ...
                                    <x-shared.error-message name="create_role" />
                                </div>
                            </form>
                        </div>
                    </div>
