<div>
    <div>
        <div class="py-3 font-bold">
            TO APPROVE (LIST OF ALL LEAVE APPLICATIONS APPROVED BY HEADS)
        </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody>
                                @forelse ($leaves as $key=>$leave)
                                    ...
                                    <tr class="{{ $key % 2 == 0 ? 'bg-gray-100' : 'bg-white' }}">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            ...
                                            <a href="#"
                                                wire:click.prevent="denyLeave('{{ $leave->id }}')"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5"
                                            class="text-center">No Leave Request</td>
                                    </tr>
        ...
        <div class="py-10 border-t-2 border-gray-400 mt-10">
            <div class="font-bold">
                LIST OF APPLICATONS
            </div>
